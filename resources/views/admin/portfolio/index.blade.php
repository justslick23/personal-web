        ...
        <div class="adm-table-wrap">
            <table class="adm-table">
                ...
                <tbody>
                    ...
                    @php
                        $thumb    = $item->image ? asset('storage/' . $item->image) : null;
                        $fallback = 'this.onerror=null;this.src=\'https://placehold.co/60x60/161616/00e676?text=' . urlencode(strtoupper(substr($item->title,0,2))) . '\'';
                    @endphp
                    <tr>
